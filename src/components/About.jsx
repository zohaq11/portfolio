...
const About = () => {
  return (
    ...
    <br /><br /> heres to more projects where i get to combine my technical skills with creativity so stay tuned for updates as i got so many ideas cooking and so much more to add here🙂‍↕️</p>
    </div>
