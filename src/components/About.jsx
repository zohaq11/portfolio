...
const About = () => {
  return (
    ...
    <p className="font-pixel text-lg text-white leading-relaxed"> Hi! I'm a HBSc 2025 graduate from UofT that studied CS and Stats and this is my portfolio website😁
